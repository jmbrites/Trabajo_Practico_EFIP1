...
public class Main {
    ...
    public static void insertarAsesor(String nombre, String apellido, String telefono, String email) {
        String query = "INSERT INTO Asesor (Nombre, Apellido, Telefono, Email) VALUES (?, ?, ?, ?)";
